...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  private FragmentSplashBinding(@NonNull FrameLayout rootView,
      @NonNull LottieAnimationView lottieLogo, @NonNull ImageView tvTitle) {
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_title;
      ImageView tvTitle = ViewBindings.findChildViewById(rootView, id);
      if (tvTitle == null) {
        break missingId;
      }

      return new FragmentSplashBinding((FrameLayout) rootView, lottieLogo, tvTitle);
    }
