...
public final class FragmentAccountBinding implements ViewBinding {
  ...
  private FragmentAccountBinding(@NonNull LinearLayout rootView, @NonNull TextView btnLogout,
      @NonNull TextView tvEmail, @NonNull TextView tvPackage) {
  ...
  public static FragmentAccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAccountBinding((LinearLayout) rootView, btnLogout, tvEmail, tvPackage);
    }
