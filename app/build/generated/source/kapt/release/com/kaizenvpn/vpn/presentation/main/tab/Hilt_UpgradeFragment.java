 ...
 */
public abstract class Hilt_UpgradeFragment<VM extends BaseViewModel, VB extends ViewBinding> extends BaseFragment<VM, VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpgradeFragment_GeneratedInjector) this.generatedComponent()).injectUpgradeFragment(UnsafeCasts.<UpgradeFragment>unsafeCast(this));
    }
  }
