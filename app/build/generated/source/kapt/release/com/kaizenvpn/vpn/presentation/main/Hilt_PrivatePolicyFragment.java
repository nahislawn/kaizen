 ...
 */
public abstract class Hilt_PrivatePolicyFragment<VM extends BaseViewModel, VB extends ViewBinding> extends BaseDialogFragment<VM, VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrivatePolicyFragment(
      Function3<? super LayoutInflater, ? super ViewGroup, ? super Boolean, ? extends VB> _binding) {
    super(_binding);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrivatePolicyFragment_GeneratedInjector) this.generatedComponent()).injectPrivatePolicyFragment(UnsafeCasts.<PrivatePolicyFragment>unsafeCast(this));
    }
  }
